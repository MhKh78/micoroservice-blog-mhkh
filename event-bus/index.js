...
app.post('/events', async (req, res) => {
  ...
  try {
    ...
    await axios.post('http://commentz-srv:4001/events', event);
    await axios.post('http://queryz-srv:4002/events', event);
    await axios.post('http://moderationz-srv:4003/events', event);
  } catch (e) {
    let status = 502;
